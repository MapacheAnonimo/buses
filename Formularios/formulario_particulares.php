...
?>
    ...
    <div class="row">
	 ...
	 <div class="col-md-4">
  		...
  		<h2 class="form__titulo"> Registra al cliente particular</h2><br>
  		<form method='POST' action='formulario_particulares.php'>
        ...
        <label for="Nombre1">Primer Nombre</label>
          <input type="text" name="Nombre1" placeholder= "Primer Nombre" class="form-control" id="Nombre1" required>
      </div>
                  <div>
        <label for="Nombre2">Segundo Nombre</label>
          <input type="text" name="Nombre2" placeholder= "Segundo nombre" class="form-control" id="Nombre2" required>
      </div>
                  <div>
        <label for="Apellido1">Apellido paterno</label>
          <input type="text" name="Apellido1" placeholder= "Apellido materno" class="form-control" id="Apellido1" required>
      </div>
                  <div>
        <label for="Apellido2">Apellido2</label>
          <input type="text" name="Apellido2" placeholder= "Sin simbolo +" class="form-control" id="Apellido2" required>
      </div>
    ...
    $sql4 = "INSERT INTO $tabla4 (Rut_Cliente,Nombre1,Nombre2,Apellido1,Apellido2) VALUES ('$Rut_Cliente','$Nombre1','$Nombre2','$Apellido1','$Apellido2')";
